...
Grp = Group Y_m2 ALL ;
ag = FOREACH Grp GENERATE AVG(Y_m2.avg_wtdstars);   

describe Y_m2; 
describe Y_rate2;
joined_data= JOIN Y_rate2 BY business_id, Y_m2 BY business_idgroup ;
Grp2 = Group joined_data  ALL;
ag2 = FOREACH Grp2 GENERATE AVG(joined_data.avg_wtdstars);   
